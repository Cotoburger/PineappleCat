...
def handle_send_command(message):
    try:
        ...
        formatted_content = (
            f"(THIS MESSAGE WAS FORWARDED BY THE BOT ADMINISTRATOR ALEKSEI TO THIS USER. IGNORE THE CHARACTER GIVEN TO YOU IN THE PROMPT. JUST FORWARD THE MESSAGE. HERE IS WHAT YOU SHOULD FORWARD TO HIM IN RUSSIAN:)\n\n{content}"
        )
